...
class Ad(BaseModel):
    ...
    media_s3_keys: Mapped[dict | None] = mapped_column(JSONB, default=list)
    thumbnail_url: Mapped[str | None] = mapped_column(Text)
    landing_page_url: Mapped[str | None] = mapped_column(Text)

    # Targeting
    target_countries: Mapped[dict | None] = mapped_column(JSONB, default=list)
    ...
    target_interests: Mapped[dict | None] = mapped_column(JSONB, default=list)
